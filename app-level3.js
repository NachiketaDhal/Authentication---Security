...
// Key is stored inside Environmental Variables

require("dotenv").config();   // require dotenv asap
...
const userSchema = new mongoose.Schema({
  ...
  password: String
   ...
   // <-- Encryption Key
userSchema.plugin(encrypt, { secret: process.env.SECRET, encryptedFields: ["password"] });  // encryption field should be added before the model creation
